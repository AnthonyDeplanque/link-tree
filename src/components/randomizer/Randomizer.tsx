  ...
  return (
    ...
    >
      <div className='randomizer'>
        ...
        {isSlotMachineDisplayed && (
          <SlotMachine slots={selectedGames} onClose={() => setIsSlotMachineDisplayed(false)} />
        )}
      </div>
      {selectedGames.length > 1 && (
        <div className='button-selector-div'>
          <button className='game-selector-button' onClick={onSlotMachineOpen}>
            Open Slot Machine
          </button>
        </div>
      )}
